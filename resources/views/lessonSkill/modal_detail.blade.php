<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <div class="modal-content pt-4 modal-content-lesson position-relative">
                        <div class="modal-header p-0 border-0 position-absolute" style="right: 30px;top: -10px;">
            ...
            <div class="custom__a modal-content-lesson1"></div>
...
{{--        $('li.item_youtube--lesson').click(function (){--}}
{{--            $.ajax({--}}
{{--                url: "{{ route('lesson.ajax') }}",--}}
{{--                method: 'GET',--}}
{{--                dataType: 'html',--}}
{{--                success: function (data) {--}}
{{--                    $('.modal-content-lesson').html(data)--}}
{{--                },--}}
{{--            })--}}
{{--        })--}}
{{--    })--}}
