                                ...
                                @if((request()->status - 1) == $key)
                                    <div class="wp__item--exam--one">
                                        ...
                                        <ul class="list_result--exam">
                                            <li class="item__list--result--exam">
                                                <div class="img__block--result">
                                                    <img class="img__redirect--exam img__redirect--exam--1"
                                                         src="{{ asset("images/item__ghep.png") }}">
                                                </div>
                                            ...
                                            <li class="item__list--result--exam">
                                                <div class="img__block--result">
                                                    <img class="img__redirect--exam img__redirect--exam--2"
                                                         src="{{ asset("images/item__ghep.png") }}">
                                                </div>
                                                <div class="title__result--exam">
                                                    {{ $value["B"] ?? '' }}
                                            ...
                                            <li class="item__list--result--exam">
                                                <div class="img__block--result">
                                                    <img class="img__redirect--exam img__redirect--exam--3"
                                                         src="{{ asset("images/item__ghep.png") }}">
                                                </div>
                                                <div class="title__result--exam">
                                                    {{ $value["C"] ?? '' }}
                                            ...
                                            <li class="item__list--result--exam">
                                                <div class="img__block--result">
                                                    <img class="img__redirect--exam img__redirect--exam--4"
                                                         src="{{ asset("images/item__ghep.png") }}">
                                                </div>
                                                <div class="title__result--exam">
                                                    {{ $value["D"] ?? '' }}
